...
const Home = () => {
  ...
  return (
    <ParallaxScrollView title='QR Scan'>
      <View >
        <ThemedText>Enter Tag Number:</ThemedText>
        ...
        <ThemedButton disabled={loading} style={{
          ...
          borderRadius: 5,
          marginBottom: 20
        }} darkColor='blue' lightColor='#7367f0' onPress={() => fetchTagDetails(tagno)}>
        ...
        <ThemedText >Or Scan QR Code:</ThemedText>
        <CameraView
          style={styles.camera}
          facing="back"
